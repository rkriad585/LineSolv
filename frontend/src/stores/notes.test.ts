...
describe('NotesManager', () => {
  ...
  describe('sort', () => {
    it('sorts by name ascending', () => {
      const notes = [makeNote({id: 'a', name: 'Banana'}), makeNote({id: 'b', name: 'Apple'}), makeNote({id: 'c', name: 'Cherry'})];
      mgr.load(notes, 'a');
    ...
    it('sorts by created ascending', () => {
      const notes = [makeNote({id: 'a', createdAt: 300}), makeNote({id: 'b', createdAt: 100}), makeNote({id: 'c', createdAt: 200})];
      mgr.load(notes, 'a');
    ...
    it('sorts by updated descending', () => {
      const notes = [makeNote({id: 'a', updatedAt: 100}), makeNote({id: 'b', updatedAt: 300}), makeNote({id: 'c', updatedAt: 200})];
      mgr.load(notes, 'a');
  ...
  describe('saveContent / setActiveContent', () => {
    it('saves content to active note', () => {
      const note = makeNote({id: 'a', content: ''});
      mgr.load([note], 'a');
      mgr.saveContent('hello world');
      expect(mgr.activeNote().content).toBe('hello world');
    });
