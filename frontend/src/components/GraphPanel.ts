...
export class GraphPanel {
  ...
  constructor() {
    ...
    closeBtn.style.cssText =
      'border:none;background:transparent;color:var(--text-muted);cursor:pointer;padding:2px;display:flex;border-radius:4px;';
    closeBtn.setAttribute('aria-label', 'Close graph');
    closeBtn.addEventListener('mouseenter', () => {
      closeBtn.style.background = 'var(--surface-secondary)';
    });
